...
from d7.core import parser, loader
from d7.core.exceptions import VariableNotFound, FunctionNotFound
from d7.core.parser import parse_string, is_variable_exists
...
class TestParserBasic(unittest.TestCase):
    ...
    def test_parse_str(self):
        ...
        result = parse_string(raw_string, variables_mapping, functions_mapping)
        self.assertEqual("abc4def", result)

    def test_is_variable_exists(self):
        variables_map = {
            "p1": 0,
            "p2": {
                "p3": "v3"
        ...
        self.assertTrue(is_variable_exists('p1', variables_map))
        self.assertTrue(is_variable_exists('p2.p3', variables_map))
        self.assertTrue(is_variable_exists('p4.0.p5', variables_map))
        self.assertFalse(is_variable_exists('not_exists', variables_map))
    ...
    def test_parse_variables_mapping(self):
        ...
        expected_variables = {"varA": "123", "varB": "123", "varC": "123", "a": 1, "b": 2}
        self.assertEqual(parsed_variables, expected_variables)
    ...
    def test_parse_data_testcase(self):
        variables = {
            "uid": "1000",
            "random": "A2dEx",
            "authorization": "a83de0ff8d2e896dbd8efb81ba14e1d7",
    ...
    def test_parse_parameters_testcase(self):
        function_map = loader.load_functions_from_script('''
...
test3,333333'''
        with tempfile.NamedTemporaryFile() as temp:
            ...
            parameters = {
                ...
                "username-password": "${parameterize(%s)}" % temp.name,
                "sum": "${calculate_two_nums(1, 2)}",
            }
            parsed_params = parser.parse_parameters(parameters, function_map)
